...
public:
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        anonymizeDIVI = new QSpinBox(tabMain);
        anonymizeDIVI->setObjectName(QStringLiteral("anonymizeDIVI"));
        anonymizeDIVI->setMinimum(100);
        anonymizeDIVI->setMaximum(100000);
        anonymizeDIVI->setSingleStep(100);
        anonymizeDIVI->setValue(1000);

        horizontalLayout->addWidget(anonymizeDIVI);
...
#ifndef QT_NO_TOOLTIP
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start DIVI after logging in to the system.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start DIVI on system login", Q_NULLPTR));
...
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("OptionsDialog", "Amount of DIVI to keep anonymized", Q_NULLPTR));
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the DIVI client port on the router. This only works when your router supports UPnP and it is enabled.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the DIVI network through a SOCKS5 proxy.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting DIVI.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
"https://www.transifex.com/divi-project/divi-project-translations", Q_NULLPTR));
